...
- [ ] **Filtro de categoria no seletor de matéria-prima da Ficha técnica** — hoje é um `<select>` simples com todas as matérias-primas. Reaproveita o cadastro de categoria que já existe. Só frontend, sem depender da API.
